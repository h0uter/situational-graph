...
class FrontierBasedExplorationStrategy2(ExplorationStrategy):
    ...
    def target_selection(self, agent: AbstractAgent, krm: KnowledgeRoadmap) -> Node:
        ...
        self._logger.debug(f"{agent.name}: {num_of_frontiers} frontiers currently in krm")
